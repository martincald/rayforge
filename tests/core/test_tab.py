...
class TestTab:
    def test_initialization(self):
        ...
        tab = Tab(width=3.0, segment_index=5, pos=0.5)
    ...
    def test_uid_generation(self):
        ...
        tab1 = Tab(width=1, segment_index=1, pos=0.1)
        tab2 = Tab(width=2, segment_index=2, pos=0.2)
    ...
    def test_custom_uid(self):
        ...
        tab = Tab(width=5.0, segment_index=0, pos=0.0, uid=custom_id)
