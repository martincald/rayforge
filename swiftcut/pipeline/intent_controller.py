...
:class:`~swiftcut.pipeline.pipeline.Pipeline` already listens to
...
1. :class:`~swiftcut.pipeline.intent_builder.IntentBuilder` is called
...
class IntentController:
    ...
    Pairs with the existing :class:`~swiftcut.pipeline.pipeline.Pipeline`
