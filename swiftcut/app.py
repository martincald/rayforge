...
def _read_language_from_config() -> str | None:
    ...
    from swiftcut.config import CONFIG_FILE
...
locale_dir = base_dir / "swiftcut" / "locale"
...
def main():
    ...
    class App(Adw.Application):
        def __init__(self, args):
            super().__init__(application_id="org.ilab.SwiftCut")
        ...
        def _load_initial_files(self, widget):
            ...
            from swiftcut.image import ImporterFeature
        ...
        def _run_uiscript(self, widget):
            ...
            from swiftcut.uiscript import run_script
        ...
        def _load_startup_files(self, widget):
            ...
            """
            from swiftcut.core.config import StartupBehavior
    ...
    from swiftcut import __version__
    ...
    from swiftcut.shared.tasker.manager import TaskManagerProxy
    ...
    task_mgr_proxy = cast(TaskManagerProxy, swiftcut.shared.tasker.task_mgr)
    ...
    swiftcut.shared.tasker.task_mgr.shutdown()
