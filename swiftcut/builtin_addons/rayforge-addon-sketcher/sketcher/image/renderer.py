...
from swiftcut.image.structures import FillRenderData, FillStyle
from swiftcut.image.svg.svg_fallback import (
    SVG_LOAD_AVAILABLE,
...
if TYPE_CHECKING:
    ...
    from swiftcut.core.workpiece import RenderContext
    from swiftcut.image.structures import ImportResult
