...
from swiftcut.ui_gtk.action_registry import (
    MenuPlacement,
    action_registry,
)
from swiftcut.ui_gtk.actions import action_extension_registry
from swiftcut.ui_gtk.canvas2d.context_menu import (
...
if TYPE_CHECKING:
    ...
    from swiftcut.ui_gtk.actions import ActionManager
