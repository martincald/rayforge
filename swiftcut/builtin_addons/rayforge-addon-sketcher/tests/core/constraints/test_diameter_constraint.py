...
from sketcher.core.constraints import DiameterConstraint
...
def test_diameter_can_apply_to_circle():
    sketch = Sketch()
    ...
    assert DiameterConstraint.can_apply_to(selection, sketch) is True


def test_diameter_can_apply_to_arc():
    sketch = Sketch()
    ...
    assert DiameterConstraint.can_apply_to(selection, sketch) is False
